...
Module LoadMockData
        Public Function GetCustomers(ByVal sender As frmMainForm) As List(Of Account)
            ...
            For Each Account In accounts
                AddHandler Account.AccountBalanceWarningEvent,
                    AddressOf sender.TheAccount_AccountBalanceWarningEvent
            Next
